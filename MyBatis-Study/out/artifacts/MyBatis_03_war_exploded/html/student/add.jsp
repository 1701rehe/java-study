...
<body class="emp_body">
    ...
    <div id="jiben">
        <form action="${pageContext.request.contextPath}/students?method=saveStudent" method="post">
        <table width="88%" class="emp_table">
            <tr>
                <td width="10%" align="left">学生姓名：</td>
                <td width="15%" align="left"><input type="text" name="name"/></td>
                <td width="10%" align="left">学生年龄：</td>
                <td width="15%" align="left"><input type="text" name="age"/></td>
                <td width="10%" align="left">学生生日：</td>
                <td width="15%" align="left"><input type="text" name="birthday"/></td>
            </tr>
        </table>
        </form>
    </div>
