...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('0102','01','学工部');
		d.add('010201','0102','在校学生管理','${pageContext.request.contextPath}/students?method=findAllStudent','','right');
		...
		d.add('0105','01','人力资源部');
		//d.add('010501','0105','部门管理','<s:property value="#listDepts"/>','','right');
		d.add('010501','0105','部门管理','${listDepts}','','right');
		d.add('010502','0105','职务管理','${listJobs}','','right');
		d.add('010503','0105','员工管理','${pageContext.request.contextPath}/users?method=findAllUser','','right');
		document.write(d);
	</script>
</div>
</tr>
